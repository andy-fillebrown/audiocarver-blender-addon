...
print("");
print("Window width = " + str(bpy.context.window.width));
print("Window height = " + str(bpy.context.window.height));
print("");
...
def load():
    ...
    file_name = "src/testing/Grieg, Edvard - Lyric Pieces Book 3 {1. The Butterfly}.ac";
...
load()
bpy.ops.wm.save_as_mainfile(filepath="src/testing/Grieg, Edvard - Lyric Pieces Book 3 {1. The Butterfly}.blend");
